...
-- Q4: Give me all the histocial data for the specific vendors that were in the market on 2019-04-03
SELECT *
FROM vendor
WHERE vendor_id IN (
						SELECT vendor_id
...
JOIN customer AS c ON c.customer_id = cp.customer_id;
...
FROM 
 ...
 -- CRAZY Q1 What is the avearge quantity by cutomer_id
